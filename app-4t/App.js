        ...
        {activeTab === 'home' && (
          <View>
            ...
            <View style={styles.card}>
              ...
              <Text style={styles.textItem}>♨️ Sấy Khô Nhanh Heatpump chống nhăn</Text>
              <Text style={styles.textItem}>🛡️ Diệt Khuẩn UV 99.9% bảo vệ sợi vải</Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={{textAlign: 'center', marginVertical: 10, fontSize: 13, color: '#64748b'}}>
              Chuyển khoản số tiền: {currentOrder?.total.toLocaleString()} VNĐ
            </Text>
