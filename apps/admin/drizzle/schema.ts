...
export const laundryOrders = mysqlTable(
  "laundryOrders",
  {
    ...
    deliveryMethod: mysqlEnum("deliveryMethod", ["store", "address"]).default("address").notNull(),
    routeDistanceMeters: int("routeDistanceMeters").default(0).notNull(),
    shippingFeeVnd: int("shippingFeeVnd").default(0).notNull(),
